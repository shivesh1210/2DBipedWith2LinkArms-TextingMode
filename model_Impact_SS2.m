function [output, ZMPx_impact, R_Force_impact_foot2] = model_Impact_SS2(q_dq)
...
%%
% Relabeling before calculating Jacobian of foot 1
q1 = q5;
q2 = q4;
qp1 = qp2;
Ac1 = [L1*cos(q1), L2*cos(q2), 0, 0, 0, 0, 0, 0, 0, hp*cos(qp1), 0, 1, 0;
       L1*sin(q1), L2*sin(q2), 0, 0, 0, 0, 0, 0, 0, hp*sin(qp1), 0, 0, 1;
